...
def fighting_menu():
    ...
    while running:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if event.button == 1:
                    ...
                    if 730 < x < 770 and 275 < y < 325:
                        enemy_shown = enemy_shown + 1 if enemy_shown + 1 <= 2 else 0
                    if 800 - 770 < x < 800 - 730 and 275 < y < 325:
                        enemy_shown = enemy_shown - 1 if enemy_shown - 1 >= 0 else 2
        screen.fill('black')
        ...
        pygame.draw.polygon(screen, 'white', ((730, 275), (770, 300), (730, 325)))
        pygame.draw.polygon(screen, 'white', ((800 - 730, 275), (800 - 770, 300), (800 - 730, 325)))
        pygame.display.flip()
        clock.tick(60)
    return enemy_shown
